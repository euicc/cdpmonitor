...
import helpers
>>>>>>> b67cd0b3633ee2310ca5b482800832e6368c4ea8
...
def check_oozie():
        ...
        for t in rows:
           if t[1] in ['FAILED','KILLED','RUNNING']:
                print(" The Job " + t[0] + " is in " + t[1] + " state" )
